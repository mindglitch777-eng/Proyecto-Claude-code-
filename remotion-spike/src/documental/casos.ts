...
export const CASOS: CasoConfig[] = [
  ...
  // 03 -- (ebook, 15/30 dias)
  {
    ...
    centro: {
      ...
      narracion: [
        'Primero, la idea.',
        'Después, investigación: ver qué buscaba la gente.',
        'Con eso armó la creación del producto.',
        'Después, la oferta: cómo lo iba a vender.',
        'Y por último, tráfico: que alguien lo viera.',
      ],
    },
  ...
  // 05 -- (2 socios, IA + infraestructura, $1M/6 meses)
  {
    ...
    centro: {
      ...
      narracion: [
        'Todo arranca con IA.',
        'Automatización: que el proceso se repita solo.',
        'Creación del producto, ya con eso armado.',
        'Distribución: que llegue a más lugares.',
        'Y monetización: convertir todo eso en dinero.',
      ],
    },
  ...
  // 06 -- (arte IA en Etsy, $7k/mes, equipo)
  {
    ...
    centro: {
      ...
      narracion: [
        'Creación: hacer las imágenes con IA.',
        'Publicación: subirlas a la tienda.',
        'Optimización: mejorar lo que ya estaba funcionando.',
        'Y atención: responder y sostener al cliente.',
      ],
    },
  ...
  // 13 -- (una pregunta -> negocio)
  {
    ...
    centro: {
      ...
      narracion: [
        ...
        'Investigación: buscar la respuesta a fondo.',
        'De ahí salió el producto.',
        'Después, una colección completa.',
        'Y al final, un negocio.',
      ],
    },
  ...
  // 18 -- (la fabrica de productos)
  {
    ...
    centro: {
      ...
      narracion: [
        'Una idea, potenciada con IA.',
        'De ahí, el producto.',
        'Una landing para mostrarlo.',
        'Tráfico para que alguien lo viera.',
  ...
  // 20 -- (el juego completo -- cierre de la serie)
  {
    ...
    centro: {
      ...
      narracion: [
        'Todo arranca identificando un problema.',
        'Después, estudiar el mercado.',
        'Un producto mínimo para probarlo rápido.',
        'Tráfico para validarlo con gente real.',
        'Y recién ahí, escalar.',
      ],
    },
